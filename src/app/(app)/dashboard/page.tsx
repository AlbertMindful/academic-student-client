        ...
        {providers.map((provider) => (
          <div key={provider.provider} className="flex items-start gap-3 rounded-md px-2 py-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              {provider.provider === "academic" && provider.status !== "ok" && <Link href="/connect/academic" className="mt-1 inline-block text-xs font-medium text-foreground underline underline-offset-2">重新绑定</Link>}
